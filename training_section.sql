...
-- sorting data product by price
SELECT * 
FROM products
ORDER BY price ASC;

-- sorting data name by price
SELECT * 
FROM products
ORDER BY name ASC;

-- second ordering sorting
SELECT * 
FROM products
...
UNION ALL -- dont try any duplicated values
(
	SELECT * 
	FROM products
	ORDER BY price / weight DESC
...
-- Structure data and Sub-queries
SELECT name, price, (
	SELECT MAX(price)
	FROM products
)
...
-- 
SELECT name, price, price/weight AS price_weight_ratio
FROM products;
